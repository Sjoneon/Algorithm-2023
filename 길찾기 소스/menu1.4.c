...
void load_road_Region(char* filename) // 지역 파일 열기
{
	int i;
	char Reg[100];
...
void T_R_Result(int start, int end) // 시간, 거리, 현재시간, 도착시간을 출력해주는 함수
{
...
void save_recent_path(int start, int finish, int hour, double minute) // 최근거리 파일 입력함수
{
