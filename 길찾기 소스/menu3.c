...
int List_del_BM(const char* filename) // 별명(지역)파일(리스트)열기 함수
{
    int delete_pos = 0;
...
void Delete(const char* filename, const char* targetArea, int delete_num) // 해당 선택한 별명 삭제 함수
{
